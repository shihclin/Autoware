...
def parse_csv(filename):
    ...
    return raw_data
#loc_data    = parse_csv("../../../csv/Contention/SameGPU/RCNN_KF/rcnn_detect_histogram.csv")
#det_data    = parse_csv("../../../csv/Contention/DifferentGPU/RCNN_KF/rcnn_detect_histogram.csv")
tra_data    = parse_csv("../../../csv/Contention/SameGPU/RCNN_KF/kf_track_histogram.csv")
vel_data    = parse_csv("../../../csv/Contention/DifferentGPU/RCNN_KF/kf_track_histogram.csv")
#ang_data    = parse_csv("../csv/angle_set_histogram.csv")
out_filename = "KF_Contention.png"
...
n, bins, patches = plt.hist(tra_data, 100, alpha=0.5, color='red', label='KF Same GPU')
n, bins, patches = plt.hist(vel_data, 100, alpha=0.5, color='blue', label='KF Different GPU')
